...
<body class="animsition">
			...
			<div class="tab01">
				...
				<div class="tab-content">
					...
					<div class="tab-pane fade bor10 m-t-50 p-t-40 p-b-40" id="withakun" role="tabpanel">
						<form class="form-horizontal" method="post" enctype="multipart/form-data" name="regform" action="?">
							<div class="col-sm-12">
							...
							<div class="form-group">
								<label class="control-label col-sm-3" for="gelardepan">Gelar Depan</label>
								<div class="col-sm-7">
									<input type="text" class="form-control" name="gelardepan">
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-sm-3" for="namadepan">Nama Depan <font color="red">*</font></label>
								<div class="col-sm-7">
									<input type="text" class="form-control" name="namadepan">
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-sm-3" for="namabelakang">Nama Belakang <font color="red">*</font></label>
								<div class="col-sm-7">
									<input type="text" class="form-control" name="namabelakang">
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-sm-3" for="gelarbelakang">Gelar Belakang</label>
								<div class="col-sm-7">
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input type="text" id="pangkat" class="form-control" name="golongan">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input type="text" name="unitkerja2" class="form-control">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label class="control-label col-sm-3" for="biografi">Profil Singkat</label>
								<div class="col-sm-7">
									<textarea name="biografi" class="form-control"> </textarea>
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-sm-3" for="hp">Foto</label>
								<div class="col-sm-7">
	...
	if (isset($_POST['submit'])) {
		...
		$query = mysqli_query($koneksi, "INSERT INTO akun VALUES ('$noAkun', '$namalengkap' ,'$nip', '$agama', '$ttl', '$jenis_kelamin', '$pekerjaan', '$status_perkawinan', '$pangkat',
			'$pendidikanterakhir','$bidang_studi','$jabatan','$unit1', '$unit2', '$alamat_kantor','$telp_kantor','$fax_kantor','$alamat_rumah','$hp','$profil_singkat','','')");
