...
<body class="animsition">
					...
					<div class="tab-pane fade bor10 m-t-50 p-t-40 p-b-40" id="withakun" role="tabpanel">
						<form class="form-horizontal" method="post" enctype="multipart/form-data" name="regform">
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input type="text" class="form-control" id="pangkat" name="golongan">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label class="control-label col-sm-3" id="changeradio" for="unitkerja">Unit Kerja Eselon I</label>
								<div class="col-sm-7">
									<input type="text" name="unitkerja1" class="form-control">
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-sm-3" id="changeradio" for="unitkerja">Unit Kerja Eselon II</label>
								<div class="col-sm-7">
									<input type="text" name="unitkerja1" class="form-control">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input type="text" class="form-control" id="notelp" name="hp">
								</div>
							</div>
							<div class="form-group">
							...
							<div class='col-sm-12'>
								<div class='alert alert-info'>
									<strong>Data Akun E-Learning</strong>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label class="control-label col-sm-3" for="password">Password<font color="red">*</font></label>
								<div class="col-sm-7">
	...
	if (isset($_POST['submit'])) {
		...
		$query = mysqli_query($koneksi, "INSERT INTO akun VALUES ('$noAkun', '$namalengkap' ,'$nip', '$agama', '$ttl', '$jenis_kelamin', '$pekerjaan', '$status_perkawinan', '$pangkat',
			'$pendidikanterakhir','$bidang_studi','$jabatan','$unit1', '$unit2', '$alamat_kantor','$telp_kantor','$fax_kantor','$alamat_rumah','$hp','$profil_singkat','$email','$passmd')");
